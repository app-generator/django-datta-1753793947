...
- Get [Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-datta-1753793947) via `eMail` and `Discord`
- Resources:
...
```bash
$ git clone https://github.com/django-datta-1753793947.git
$ cd django-datta-1753793947
```
